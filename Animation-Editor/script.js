...
// Animation-Editor by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Animation-Editor!', 'info');
...
console.log('%cAnimation-Editor', 'font-size: 24px; font-weight: bold; color: #667eea;');
