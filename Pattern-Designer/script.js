...
// Pattern-Designer by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Pattern-Designer!', 'info');
...
console.log('%cPattern-Designer', 'font-size: 24px; font-weight: bold; color: #667eea;');
