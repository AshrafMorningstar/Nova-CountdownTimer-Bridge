...
// Video-Effects by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Video-Effects!', 'info');
...
console.log('%cVideo-Effects', 'font-size: 24px; font-weight: bold; color: #667eea;');
