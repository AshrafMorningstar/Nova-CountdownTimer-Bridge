...
// Font-Generator by Ashraf Morningstar
...
document.addEventListener('DOMContentLoaded', () => {
    showNotification('Welcome to Font-Generator!', 'info');
...
console.log('%cFont-Generator', 'font-size: 24px; font-weight: bold; color: #667eea;');
